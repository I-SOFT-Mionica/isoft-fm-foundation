...
$time       = (string) get_option( 'isoft_fmf_integrity_check_time', '02:30' );
$autorelink = (bool) get_option( 'isoft_fmf_integrity_autorelink', 1 );
$use_inode  = (bool) get_option( 'isoft_fmf_integrity_use_inode', 1 );
...
<div class="isoft-fmf-maintenance-tab" style="margin-top:1.5em;">
	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isoft_fmf_integrity_check_enabled" value="1" <?php checked( $enabled ); ?> />
			...
			<tr>
				...
				<td>
					<input type="time"
						name="isoft_fmf_integrity_check_time"
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isoft_fmf_integrity_autorelink" value="1" <?php checked( $autorelink ); ?> />
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isoft_fmf_integrity_use_inode" value="1" <?php checked( $use_inode ); ?> />
	...
	<?php if ( ! ISOFT_FMF_Demo_Content::has_content() ) : ?>
		<p class="description" style="max-width:780px;">
		...
		<p>
			<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=isoft_fmf_install_demo' ), 'isoft_fmf_install_demo' ) ); ?>"
	...
	<?php elseif ( ISOFT_FMF_Demo_Content::has_demo_content() ) : ?>
		<p class="description" style="max-width:780px;">
		...
		<p>
			<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=isoft_fmf_remove_demo' ), 'isoft_fmf_remove_demo' ) ); ?>"
				class="button"
